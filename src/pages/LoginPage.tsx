...
function LoginPage() {
  ...
  return (
    <main className="flex flex-1 p-4 justify-center items-center">
      <form onSubmit={onLogin} className="max-w-md w-full bg-white p-6 rounded-lg border-2 border-gray-300">
        ...
        <div className="mt-6 flex justify-end">
          <button type="submit" className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Login</button>
        </div>
        <div className="mt-2 flex justify-end">
          <p>Didn't have account? <Link className='text-indigo-600' to="/register">Register here</Link></p>
        </div>
      </form>
    </main>
  )
